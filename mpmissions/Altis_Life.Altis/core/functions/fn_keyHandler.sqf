...
switch (_code) do {
    ...
    if (LIFE_SETTINGS(getNumber,"disableCommanderView") isEqualTo 1) then {
        ...
        if (_code in _CommandMode) then {
            [ localize "STR_NOTF_CommanderView",false,"fast"] call AYU_Client_fnc_notification_system;
            _handled = true;
        };
    };
    ...
    case 24: {
        if (_shift) then {
            if !(soundVolume isEqualTo 1) then {
                1 fadeSound 1;
                [ localize "STR_MISC_soundnormal",false,"fast"] call AYU_Client_fnc_notification_system;
            } else {
                1 fadeSound 0.1;
                [ localize "STR_MISC_soundfade",false,"fast"] call AYU_Client_fnc_notification_system;
            };
        };
    };
        ...
        if (!_alt && !_ctrlKey) then {
            ...
            if (_veh isKindOf "House_F" && {playerSide isEqualTo civilian}) then {
                if (_veh in life_vehicles && {player distance _veh < 20}) then {
                    ...
                    if (_door isEqualTo 0) exitWith {[ localize "STR_House_Door_NotNear",false,"fast"] call AYU_Client_fnc_notification_system;};
                    ...
                    if (_locked isEqualTo 0) then {
                        ...
                        [ localize "STR_House_Door_Lock",false,"fast"] call AYU_Client_fnc_notification_system;
                    } else {
                        _veh setVariable [format ["bis_disabled_Door_%1",_door],0,true];
                        _veh animateSource [format ["Door_%1_source", _door], 1];
                        [ localize "STR_House_Door_Unlock",false,"fast"] call AYU_Client_fnc_notification_system;
                    };
                };
            } else {
                ...
                if (_veh in life_vehicles && {player distance _veh < 20}) then {
                    if (_locked isEqualTo 2) then {
                        ...
                        [ localize "STR_MISC_VehUnlock",false,"fast"] call AYU_Client_fnc_notification_system;
                        ...
                        [ localize "STR_MISC_VehLock",false,"fast"] call AYU_Client_fnc_notification_system;
