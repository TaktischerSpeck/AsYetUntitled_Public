...
if (player getVariable "restrained") exitWith {
    [ localize "STR_NOTF_isrestrained",false,"fast"] call AYU_Client_fnc_notification_system;
};
_exit = false;
if (player getVariable "playerSurrender") exitWith {
    [ localize "STR_NOTF_surrender",false,"fast"] call AYU_Client_fnc_notification_system;
};
