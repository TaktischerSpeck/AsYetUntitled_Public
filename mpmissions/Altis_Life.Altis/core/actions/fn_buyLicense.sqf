...
if (CASH < _price) exitWith {[ format [localize "STR_NOTF_NE_1",[_price] call life_fnc_numberText,localize _displayName],false,"fast"] call AYU_Client_fnc_notification_system;};
CASH = CASH - _price;
