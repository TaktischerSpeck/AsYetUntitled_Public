...
if ((time - life_action_delay) < 2) exitWith {[ localize "STR_NOTF_ActionDelay",false,"fast"] call AYU_Client_fnc_notification_system; INUSE(_this);};
...
if (_diff <= 0) exitWith {[ localize "STR_NOTF_InvFull",false,"fast"] call AYU_Client_fnc_notification_system; INUSE(_this);};
