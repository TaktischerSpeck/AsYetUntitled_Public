...
*/
private "_value";
if ((time - life_action_delay) < 1.5) exitWith {[ localize "STR_NOTF_ActionDelay",false,"fast"] call AYU_Client_fnc_notification_system; _this setVariable ["inUse",false,true];};
