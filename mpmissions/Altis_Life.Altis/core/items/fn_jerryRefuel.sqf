...
if (isNull _vehicle) exitWith {[ localize "STR_ISTR_Jerry_NotLooking",true,"fast"] call AYU_Client_fnc_notification_system;};
if (!(_vehicle isKindOF "LandVehicle") && !(_vehicle isKindOf "Air") && !(_vehicle isKindOf "Ship")) exitWith {};
if (player distance _vehicle > 7.5) exitWith {[ localize "STR_ISTR_Jerry_NotNear",true,"fast"] call AYU_Client_fnc_notification_system;};
