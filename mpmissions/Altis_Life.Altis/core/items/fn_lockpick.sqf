...
if (_isVehicle && _curTarget in life_vehicles) exitWith {[ localize "STR_ISTR_Lock_AlreadyHave",false,"fast"] call AYU_Client_fnc_notification_system;};

//More error checks
if (!_isVehicle && !isPlayer _curTarget) exitWith {};
if (!_isVehicle && !(_curTarget getVariable ["restrained",false])) exitWith {};
if (_curTarget getVariable "NPC") exitWith {[ localize "STR_NPC_Protected",false,"fast"] call AYU_Client_fnc_notification_system;};
