...
*/
if !(playerSide isEqualTo west) exitWith {[ localize "STR_Cop_wantedList_notCop",true,"fast"] call AYU_Client_fnc_notification_system;};
if ((lbCurSel 2406) isEqualTo -1) exitWith {[ localize "STR_Cop_wantedList_noPlayerSelected",true,"fast"] call AYU_Client_fnc_notification_system;};
if ((lbCurSel 2407) isEqualTo -1) exitWith {[ localize "STR_Cop_wantedList_noCrimeSelected",true,"fast"] call AYU_Client_fnc_notification_system;};
