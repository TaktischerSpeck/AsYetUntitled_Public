...
if (_target getVariable ["Reviving",objNull] == player) exitWith {[ localize "STR_Medic_AlreadyReviving",false,"fast"] call AYU_Client_fnc_notification_system;};
...
if (_target getVariable ["Reviving",objNull] != player) exitWith {[ localize "STR_Medic_AlreadyReviving",false,"fast"] call AYU_Client_fnc_notification_system; life_action_inUse = false;};
_target setVariable ["Reviving",NIL,true];

if (!alive player || life_istazed || life_isknocked) exitWith {life_action_inUse = false;};
if (_target getVariable ["Revive",false]) exitWith {[ localize "STR_Medic_RevivedRespawned",false,"fast"] call AYU_Client_fnc_notification_system; life_action_inUse = false;};
