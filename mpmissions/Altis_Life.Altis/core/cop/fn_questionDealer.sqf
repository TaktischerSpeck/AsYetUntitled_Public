...
if (count _sellers isEqualTo 0) exitWith {[ localize "STR_Cop_DealerQuestion",true,"fast"] call AYU_Client_fnc_notification_system;}; //No data.
...
[ parseText format [(localize "STR_Cop_DealerMSG")+ "<br/><br/>%1",_names],false,"slow"] call AYU_Client_fnc_notification_system;
