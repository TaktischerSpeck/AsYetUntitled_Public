...
if (count _vehicleInfo isEqualTo 0) exitWith {[ localize "STR_Cop_VehEmpty",true,"fast"] call AYU_Client_fnc_notification_system;};
...
if (_value > 0) then {
    ...
    [ localize "STR_Cop_NoIllegalVeh",true,"fast"] call AYU_Client_fnc_notification_system;;
};
