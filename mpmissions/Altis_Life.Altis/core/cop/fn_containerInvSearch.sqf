...
if (count _containerInfo isEqualTo 0) exitWith {[ localize "STR_Cop_ContainerEmpty",false,"fast"] call AYU_Client_fnc_notification_system;};
...
if (_value > 0) then {
    ...
    [ localize "STR_Cop_NoIllegalContainer",false,"fast"] call AYU_Client_fnc_notification_system;
};
