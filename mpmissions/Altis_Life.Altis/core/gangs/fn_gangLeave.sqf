...
if (getPlayerUID player isEqualTo (group player getVariable "gang_owner")) exitWith {[ localize "STR_GNOTF_LeaderLeave",false,"fast"] call AYU_Client_fnc_notification_system;};
