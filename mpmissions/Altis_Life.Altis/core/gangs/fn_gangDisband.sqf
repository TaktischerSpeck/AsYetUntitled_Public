...
if (_action) then {
    [ localize "STR_GNOTF_DisbandGangPro",false,"fast"] call AYU_Client_fnc_notification_system;
    ...
    [ localize "STR_GNOTF_DisbandGangCanc",false,"fast"] call AYU_Client_fnc_notification_system;
};