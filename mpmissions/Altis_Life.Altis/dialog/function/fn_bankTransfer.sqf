...
if ((lbCurSel 2703) isEqualTo -1) exitWith {[ localize "STR_ATM_NoneSelected",true,'fast'] call AYU_Client_fnc_notification_system;};
if (isNil "_unit") exitWith {[ localize "STR_ATM_DoesntExist",true,'fast'] call AYU_Client_fnc_notification_system};
if (_value > 999999) exitWith {[ localize "STR_ATM_TransferMax",true,'fast'] call AYU_Client_fnc_notification_system;};
...
if ((_value + _tax) > BANK) exitWith {[ format [localize "STR_ATM_SentMoneyFail",_value,_tax],true,'fast'] call AYU_Client_fnc_notification_system;};
...
[ format [localize "STR_ATM_SentMoneySuccess",[_value] call life_fnc_numberText,_unit getVariable ["realname",name _unit],[_tax] call life_fnc_numberText],true,'fast'] call AYU_Client_fnc_notification_system;
